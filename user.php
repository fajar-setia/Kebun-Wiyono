...
<body>
  ...
  <div class="hero-section">
    <div class="container hero-content">
      ...
      <a href="#produk" class="btn btn-primary btn-lg hero-btn fade-up">Lihat Produk Kami</a>
    </div>
  </div>
            ...
            <div class="product-card">
              ...
              <div class="card-body">
                ...
                <div class="product-actions">
                  <a href="userFeature/detailProduk.php?id=<?= $row['id']; ?>" class="btn btn-primary btn-detail">
